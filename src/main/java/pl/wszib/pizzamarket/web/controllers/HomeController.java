...
@Controller  // żeby to był Controller to musimy oznaczyć tę klasę jako Controller
public class HomeController { // ta klasa to jest Controller do strony głównej
